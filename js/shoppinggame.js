...
const dateDiff = (date1, date2) => {
  ...
  let miliSecsBetween = firstDate - secondDate;
  let daysBetween = Math.round(miliSecsBetween / oneDay);
...
// console.log(Object.getOwnPropertyNames(MagicProduct.prototype));
